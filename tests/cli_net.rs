...
fn test_net_syntenic_basic() -> Result<(), Box<dyn std::error::Error>> {
    ...
    writeln!(in_file, " fill 100 200 chr2 + 50 200 id 1 score 100 ali 200")?;
    writeln!(in_file, " fill 500 100 chr2 + 100 100 id 2 score 50 ali 100")?;
...
fn test_net_syntenic_nested() -> Result<(), Box<dyn std::error::Error>> {
    ...
    writeln!(in_file, "   fill 100 100 chr2 + 100 100 id 2 score 50 ali 100")?;
...
fn test_net_split() -> Result<(), Box<dyn std::error::Error>> {
    ...
    writeln!(in_file, " fill 100 200 chrB - 100 200 id 2 score 200 ali 200")?;
...
fn test_net_subset_basic() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Chain: 0-1000.
    let mut chain_file = NamedTempFile::new()?;
    writeln!(chain_file, "chain 1000 chr1 1000 + 0 1000 chr2 1000 + 0 1000 1")?;
    ...
    writeln!(net_file, " fill 100 100 chr2 + 100 100 id 1 score 100 ali 100")?;
...
fn test_net_subset_split_on_insert() -> Result<(), Box<dyn std::error::Error>> {
    ...
    writeln!(net_file, "   fill 200 100 chr2 + 200 100 id 2 score 100 ali 100")?;
