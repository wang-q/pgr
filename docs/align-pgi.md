...
and `pgr align lastz` gap filling is implemented as `pgr align fill` (see
[align-fill.md](align-fill.md)); `pgr align rest` extends the filling to the
whole-genome complement.
