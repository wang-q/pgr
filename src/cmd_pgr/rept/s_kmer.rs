...
/// Build the clap subcommand for s-kmer.
pub fn make_subcommand() -> Command {
    Command::new("s-kmer")
        .about("Identifies repetitive regions in a genome (self k-mer)")
        .after_help(
            r###"
This command identifies repetitive regions in a genome using self k-mer depth
analysis; no repeat library is needed.
...
pub fn execute(args: &ArgMatches) -> anyhow::Result<()> {
    ...
    let ctx = pgr::libs::pl::PipelineCtx::new("pgr_rept_s_")?;
