...
pub fn execute(args: &ArgMatches) -> anyhow::Result<()> {
    ...
    let hybrid_opts = pgr::libs::align::hybrid::HybridOptions {
    ...
    let combined = pgr::libs::align::hybrid::run_hybrid(
        &pgr,
        &abs_target_2bit,
        &abs_query_2bit,
        &avail_psl,
...
fn read_psl(path: &str) -> anyhow::Result<Vec<pgr::libs::fmt::psl::Psl>> {
