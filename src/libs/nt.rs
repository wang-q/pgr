...
/// assert_eq!(&pgr::libs::nt::translate(dna), "ASRIVAS");
///
/// let rna = b"GCUAGUCGUAUCGUAGCUAGUC";
/// assert_eq!(&pgr::libs::nt::translate(rna), "ASRIVAS");
///
/// // To shift the reading frame, pass in a slice
/// assert_eq!(&pgr::libs::nt::translate(&dna[1..]), "LVVS*LV");
/// assert_eq!(&pgr::libs::nt::translate(&dna[2..]), "*SYRS*");
/// ```
