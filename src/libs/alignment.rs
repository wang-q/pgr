...
/// // difference 5
/// // comparable 10
/// assert_eq!(pgr::libs::alignment::pair_d(seq1, seq2), 0.5);
/// ```
...
///     b"aaaatttttg".as_ref(),
/// ];
/// assert_eq!(pgr::libs::alignment::alignment_stat(&seqs), (10, 10, 1, 0, 0, 0.1,));
///
/// let seqs = vec![
///     //*          * *
...
/// ];
/// assert_eq!(pgr::libs::alignment::alignment_stat(&seqs), (17, 16, 2, 1, 0, 0.125,));
///
/// let seqs = vec![
///     //    * **    *   ** *   *
...
/// ];
/// assert_eq!(pgr::libs::alignment::alignment_stat(&seqs), (24, 21, 5, 2, 1, 0.238,));
///
/// ```
...
///         ];
///         let cons = pgr::libs::alignment::get_consensus_poa(&seqs).unwrap();
